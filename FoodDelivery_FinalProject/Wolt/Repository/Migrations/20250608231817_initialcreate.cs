    ...
    public partial class initialcreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MenuItemDiscounts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MenuItemDiscounts_Discounts_DiscountId",
                        column: x => x.DiscountId,
                        principalTable: "Discounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MenuItemDiscounts_MenuItems_MenuItemId",
                        column: x => x.MenuItemId,
                        principalTable: "MenuItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuItemDiscounts_DiscountId",
                table: "MenuItemDiscounts",
                column: "DiscountId");

            migrationBuilder.CreateIndex(
                name: "IX_MenuItemDiscounts_MenuItemId",
                table: "MenuItemDiscounts",
                column: "MenuItemId");
